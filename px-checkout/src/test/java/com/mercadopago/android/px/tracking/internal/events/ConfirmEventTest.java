...
public class ConfirmEventTest {
    ...
    private static final String EXPECTED_JUST_CARD =
        "{review_type=one_tap, payment_method_selected_index=2, payment_method_id=visa, payment_method_type=credit_card, extra_info={has_split=false, has_interest_free=false, has_reimbursement=false, card_id=123, selected_installment={quantity=1, installment_amount=10, visible_total_price=10, interest_rate=10}, issuer_id=0, has_esc=false}}";
